    ...
    <section id="footer" className="bg-black text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="footer-section about">
            <h1 className="text-3xl font-bold mb-4">
              <span className="text-yellow-400">Food</span> Rescue
            </h1>
            ...
            <div className="contact space-y-2">
              ...
              <span className="block"><i className="fas fa-envelope"></i> support@foodrescue.org</span>
            </div>
        ...
        <div className="footer-bottom text-center mt-8">
          &copy; 2025 Food Rescue | Designed by Akshit , Mohit , Tripuri 
        </div>
      </div>
    </section>
  );
