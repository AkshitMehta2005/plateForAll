  ...
  return (
    <div className="bg-gray-100 text-gray-900 mt-30">
      ...
      <header
        ...
        style={{
          backgroundImage:
            "url('https://th.bing.com/th/id/R.b6ec21aad1cacc5ba925ec572a3c059b?rik=AJUG9k3zJvoNNA&riu=http%3a%2f%2fwww.developmentnews.in%2fwp-content%2fuploads%2f2017%2f11%2fFeeding-India.jpg&ehk=7H8aLzbqHgrniGsFCJ1wp%2bIBljlM7W6nQoryZnQI6v0%3d&risl=&pid=ImgRaw&r=0')",
      ...
      >
        <div className="bg-black bg-opacity-30 p-10 rounded-lg">
          ...
          <div className="mt-6">
            <button className="bg-yellow-500 text-white px-6 py-3 rounded-lg mr-4 hover:bg-yellow-600 transition duration-300">
              Donate Now
            </button>
      ...
      <section className="text-center py-16 px-6 bg-white">
        ...
        <p className="text-lg text-gray-600 mt-4">
          We are dedicated to ending hunger by providing meals to those in need.
        </p>
      </section>
